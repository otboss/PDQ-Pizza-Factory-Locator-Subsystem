...
Run the following commands within the project directory's root using the current system's shell. If you are using an operating system other than linux then replace 'linux' in the command's path to your operating system before executing. Supported operating systems are:
<br>
<br>
<ul>
	<li>linux</li>
